...
void main()
{
  ...
  // Note that worldPos can be calculated with gl_WorldRayOriginEXT + gl_WorldRayDirectionEXT * gl_HitTEXT but this
  // can have precision issues if the hit point is far away hence we computing the position by interpolation, as for the normal
